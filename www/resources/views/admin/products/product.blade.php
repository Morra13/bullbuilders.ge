@extends('layouts.app', ['title' => __('admin.products') ])
    ...
    <div class="header pb-8 pt-5" style="background-image: url(../../../argon/img/theme/example-4.png); background-size: cover; background-position: center top;">
        ...
        <div class="container-fluid">
            <div class="header-body">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-white">{{ __('admin.products') }}</h1>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="name">{{ __('admin.price') }}</th>
                                <th scope="col" class="sort" data-sort="name">{{ __('admin.delete') }}</th>
                            </tr>
                            </thead>
                            <tbody class="list">
                            @foreach ($arProducts as $product)
                                @include('admin.products.productRow', ['product' => $product])
                            @endforeach
                            </tbody>
                        </table>
                    </div>
