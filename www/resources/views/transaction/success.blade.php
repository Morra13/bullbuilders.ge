                    ...
                    <div class="col-xl-8 mb-5 mb-xl-0">
                        <div class="card card-profile shadow">
                            ...
                            <div class="card-body pt-0 mt-0 pt-md-4">
                                <div class="text-center">
                                    <img src="https://creatory.pro/argon/img/theme/payment_success.png" alt="" style="width: 100%; max-width: 300px;">
                                    <h2 class="pt-4">
                                        {{$instruction->price_view}} USD
                                    </h2>
                                    <hr class="my-4" />
                                    <p class="text-center">
                                        You will receive a PDF with instructions to the specified email
                                    </p>
                                </div>
                            </div>
                        </div>
