@extends('layouts.app', ['title' => __('ჩამოწერილი პროდუქტების ნახვა')])
@section('content')
    <div class="header pb-8 pt-5" style="background-image: url(../argon/img/theme/instagram-2.jpg); background-size: cover; background-position: center top;">
        ...
        <div class="container-fluid">
            <div class="header-body">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-white">ჩამოწერილი პროდუქტების ნახვა</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-3 col-lg-6">
                        <form method="get" action="{{ route(\App\Http\Controllers\OffsController::ROUTE_OFFS_CHECK) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('get')
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                <th scope="col" class="sort" data-sort="name">ჩამოწერის ნომერი</th>
                            ...
                            <tbody class="list">
                            @foreach($arOffs as $offs)
                                @include('offs.row-offsCheck', ['offs' => $offs])
                            @endforeach
                            </tbody>
                        </table>
                    </div>
